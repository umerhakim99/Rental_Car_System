...
class BookingSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Booking
        fields = ['id', 'user', 'car', 'start_date', 'end_date', 'rent_amount', 'total_rent', 'status']

    def get_total_rent(self, obj):
        months = max(1, (obj.end_date.year - obj.start_date.year) * 12 + (obj.end_date.month - obj.start_date.month + 1))
